...
public class Lever : MonoBehaviour, IInteractable
{
    ...
    public string playerTag = "Player"; // This will be customizable in the Inspector
    ...
    public string openText = "Press E to pull the lever counterclockwise"; // Customizable open text
    public string closeText = "Press E to pull the lever clockwise"; // Customizable close text
    ...
    void Start()
    {
        ...
        if (player == null)
        {
            Debug.LogError("Player not found. Make sure there is a GameObject with the specified tag in the scene.");
        }
    ...
    {
        return isOpen ? openText : closeText;
    }
}
